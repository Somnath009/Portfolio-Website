...
const Navbar = () => {
  ...
  return (
    ...
    >
        <div className={`mx-auto max-w-7xl flex items-center justify-between transition-all duration-500 ${scrolled ? 'bg-white/5 border border-white/10 backdrop-blur-xl rounded-full px-6 py-3 shadow-[0_10px_40px_rgba(0,0,0,0.5)]' : 'bg-transparent px-2 py-2'}`}>
            
            {/* LOGO */}
            <h1 className='font-sans text-white text-xl md:text-2xl font-bold tracking-tighter cursor-pointer select-none group flex items-center gap-1.5' onClick={(e) => handleScroll(e, 'home')}>
