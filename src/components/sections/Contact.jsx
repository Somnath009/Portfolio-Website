...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="relative bg-[#030303] py-24 md:py-40 px-6 md:px-12 border-t border-white/5"
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-20">
        {/* Info Side */}
        <div
          data-aos="fade-right"
          className="w-full md:w-[45%] flex flex-col justify-between"
        >
          <div>
            <h2 className="text-5xl md:text-8xl font-black text-white tracking-tighter leading-none mb-6">
              ...
              <span
                ...
                style={{ WebkitTextStroke: "2px #ff7300" }}
              >
                Talk.
              </span>
            </h2>
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4 group">
              ...
              <div>
                ...
                <a
                  href="mailto:08paulsomnath@gmail.com"
                  className="text-white text-lg hover:text-brand transition-colors"
                >
            ...
            <div className="pt-8 flex gap-6">
              {[
                ...
                {
                  icon: FaLinkedin,
                  link: "https://www.linkedin.com/in/somnath-paul-0a453322a",
                },
                {
                  icon: FaInstagram,
                  link: "https://www.instagram.com/somnath_devx",
                },
              ].map((IconRef, i) => (
                <a
                  key={i}
        ...
        >
          <form onSubmit={handleSubmit} className="flex flex-col gap-10">
            ...
            <button
              type="submit"
              className="group self-start flex items-center gap-4 mt-4"
            >
              <span className="text-white text-lg font-medium tracking-wide group-hover:text-brand transition-colors">
                Send Message
              </span>
