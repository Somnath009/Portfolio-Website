...
const Hero = () => {
  const textVariants = {
    ...
    visible: { 
      y: 0, 
      opacity: 1, 
      transition: { duration: 1.2, ease: [0.33, 1, 0.68, 1], staggerChildren: 0.2 } 
    }
  };

  return (
    <div id="home" className='h-svh w-full relative overflow-hidden flex flex-col justify-end lg:justify-center items-start px-6 md:px-12 lg:px-24 pb-20 lg:pb-0 bg-[#030303]'>
        ...
        >
            <img loading="eager" className='w-full h-full object-cover object-[center_top] filter grayscale md:grayscale-0 opacity-60 md:opacity-80 transition-all duration-1000' src={image} alt="Hero Background" />
